...
export class FixGameEntitiesSchema1757146000000 implements MigrationInterface {
    name = 'FixGameEntitiesSchema1757146000000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE IF EXISTS "player" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."answers_status_enum"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."player_status_enum"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."game_status_enum"`);
        ...
        await queryRunner.query(`CREATE TABLE "player" (
            ...
            "status" "public"."player_status_enum", 
        ...
        await queryRunner.query(`CREATE TABLE "game" (
            "id" uuid NOT NULL DEFAULT uuid_generate_v4(), 
            "status" "public"."game_status_enum" NOT NULL DEFAULT 'PendingSecondPlayer', 
            "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), 
            "startGameDate" TIMESTAMP WITH TIME ZONE, 
            "finishGameDate" TIMESTAMP WITH TIME ZONE, 
            "firstPlayerId" uuid, 
            "secondPlayerId" uuid, 
            CONSTRAINT "REL_e2e6d984f70f61e5435c3be619" UNIQUE ("firstPlayerId"), 
            CONSTRAINT "REL_ee762a5104680b6af6cf7b94f6" UNIQUE ("secondPlayerId"), 
        ...
        await queryRunner.query(`CREATE TABLE "answers" (
            ...
            "status" "public"."answers_status_enum" NOT NULL, 
