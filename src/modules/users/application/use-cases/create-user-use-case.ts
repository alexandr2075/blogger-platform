...
export class CreateUserCommand {
  ...
  export class CreateUserUseCase {
    ...
    async execute(
      ...
      const userLogin = await this.usersRepository.findByLoginOrEmail(command.dto.login);
      const userEmail = await this.usersRepository.findByLoginOrEmail(command.dto.email);
